...
export class Game121 {
    constructor(level = 1, isTraining = false, customSettings = null) {
        ...
        this.levelConfig = {
            ...
            'daily':  { start: 121,  rounds: 3, check: 'single', totalTargets: 4,  minPoints: 10, resetToStart: true,  malus: 1 },
            'daily2': { start: 121,  rounds: 3, check: 'single', totalTargets: 4,  minPoints: 10, resetToStart: true,  malus: 1 },
