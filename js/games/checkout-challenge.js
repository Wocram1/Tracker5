...
export class CheckoutChallenge {
    constructor(level = 1, isTraining = false, customSettings = null) {
        ...
        this.levelConfig = {
            1:  { range: [21, 41],   attempts: 4, check: 'single', minPoints: 10,  malus: 1,  roundsPerTarget: 3 },
            2:  { range: [31, 51],  attempts: 5, check: 'single', minPoints: 15,  malus: 2,  roundsPerTarget: 3 },
